...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const classes = cn(
      "flex items-center justify-center whitespace-nowrap rounded-md font-medium transition-all transform focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 cursor-pointer disabled:opacity-50",
      variant === "default" &&
